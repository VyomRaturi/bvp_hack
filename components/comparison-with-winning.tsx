...
function calculateTeamAverageScores(teams: Team[]): number[] {
    return teams.map(team => {
        const totalScore = team.scores.reduce((acc, scoreObj) => acc + scoreObj.score, 0);
...
const chartData = [
    ...
    { parameter: "Mode", value: mode.length > 0 ? mode[0] : 0, fill: "var(--color-Mode)" }, // Display the first mode if it exists
    { parameter: "Median", value: median, fill: "var(--color-Median)" },
    { parameter: "YourTeamAverage", value: averageScores[0], fill: "var(--color-YourTeamAverage)" } // Assuming the first team is "Your Team"
];
            ...
            <CardContent className="bg-muted">
                <ChartContainer config={chartConfig}>
                    ...
                    >
                        ...
                        />
                        <Bar dataKey="value" layout="vertical" fill="var(--color-Team)" radius={5} />
                    </BarChart>
                </ChartContainer>
            </CardContent>
